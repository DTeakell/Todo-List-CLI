...
// Cachimg system to persist data
        ...
        func addTodo() {
            ...
            if let title = readLine() {
                ...
                if let description = readLine() {
                    ...
                    cache.save(todos: todoManager.todoList)
